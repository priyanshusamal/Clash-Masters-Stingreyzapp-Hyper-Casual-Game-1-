...
public enum HapticTypes { Selection, Success, Warning, Failure, LightImpact, MediumImpact, HeavyImpact , UltraLightImapact}
public class AndroidTaptic {

    public static long UltraLightDuration = 25;
    public static long LightDuration = 20;
    public static long MediumDuration = 40;
    public static long HeavyDuration = 80;
    public static int UltraLightAmplitude = 90;
    ...
    public static void Haptic(HapticTypes type) {
        try {
            switch (type) {
                ...
                case HapticTypes.UltraLightImapact:
                    AndroidVibrate(UltraLightDuration, UltraLightAmplitude);
                    break;
